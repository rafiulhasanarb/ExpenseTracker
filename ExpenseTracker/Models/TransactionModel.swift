...
extension Category {
    ...
    static let publicTransportation = Category(id: 181, name: "Public Transportations", icon: .bus, mainCategoryId: 1)
    static let taxi = Category(id: 182, name: "Taxi", icon: .taxi, mainCategoryId: 1)
    static let mobilePhone = Category(id: 281, name: "Mobile Phone", icon: .mobile_alt, mainCategoryId: 2)
    static let moviesAndDVDs = Category(id: 301, name: "Movies & DVDs", icon: .film, mainCategoryId: 3)
    static let bankFee = Category(id: 401, name: "Bank Foe", icon: .hand_holding_usd, mainCategoryId: 4)
    ...
    static let restaurants = Category(id: 582, name: "Restaurants", icon: .utensils, mainCategoryId: 5)
